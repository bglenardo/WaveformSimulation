...
int main(int argc, char * argv[]) {
   ...
   sprintf(outfile_name,"/p/lscratchd/lenardo1/NewAreaCorrections/AreaCorrections%03d_new_cor_fit_cut_perr_025_11-17-16-%d.root",
//   sprintf(outfile_name,"test.root",
           photons_in_array,run_num);
...
//     for(int ii=0; ii<100; ii++) {
      ...
      if( n_phot > 0 )
        fit_num = AssignTrueToFitPhotons( true_times, fit_times, fit_areas );
